...
import allure
@allure.epic("deleted cases")
class TestUserDelete(BaseCase):

    @allure.story("try delete user 2")
    ...
    @allure.feature("register, login and delete user")
    ...
    @allure.story( "try delete another createduser")
    #@allure.testcase(url:https://software-testing.ru/lms/mod/assign/view.php?id=207365, name:'Тесты на DELETE')
    def test_delete_another_created_user(self):
        ...
        assert response14.content.decode(
